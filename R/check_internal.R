.check_internal <- function(expr, include_compiled = FALSE, include_datasets = FALSE, skip_globals = NULL, verbose = FALSE) {
      ...
      c(
          ...
          structure(
              ...
              names = c("last.dump", "last.warning", ".Last.value", ".Random.seed", ".Traceback",
                  "shell", "shell.exec", "Sys.junction", ".GenericDefEnv", ".GenericCallEnv", ".Method",
                  ".Group", ".Class", ".Generic")
          ),
  ...
  ## walk expression
  .Call(walk_expr, expr, env0, envi, envg, environment(), srcrefi, srcrefg, isTRUE(include_compiled), isTRUE(verbose), isTRUE(include_datasets))
