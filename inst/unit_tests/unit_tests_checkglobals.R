...
if(nzchar(Sys.getenv("TAR"))) {
  check6 <- checkglobals(pkg = system.file("unit_tests", "pkg", "testpkg_1.0.tar.gz", package = "checkglobals"))
  check7 <- checkglobals(pkg = file.path("file:", system.file("unit_tests", "pkg", "testpkg_1.0.tar.gz", package = "checkglobals"), fsep = "//"))
}
